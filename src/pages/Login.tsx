...
const Login = () => {
    return ( 
        ...
        <article className="relative">
            <div className="relative w-screen h-105 overflow-hidden">
            <img className="w-full h-full object-cover object-bottom" src="/img/Union.png" alt="Person doing a handstand" />
            </div>
        ...
        <h1 className="text-2xl font-medium text-center text-dark-green">We are what we do</h1>
        <p className="text-center text-gray text-sm">Thousand of people are using silent moon  
